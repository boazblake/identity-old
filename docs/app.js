...
exports.TicTacToe = exports.ShapeShifter = exports.GameOfLife = void 0;
...
exports.toDto = exports.sendMessage = exports.saveJsonMdl = exports.initMithrilInspector = exports.getLocalMdl = void 0;
...
var hasRepos = function hasRepos() {
  var age = parseInt(localStorage.getItem("repos-date"));
  var now = Date.now();
  return (now - age) / 1000 >= 3600 ? (localStorage.clear("repos"), null) : localStorage.getItem("repos");
};

var fetchRepos = function fetchRepos(mdl) {
  mdl.portfolio.reposList = JSON.parse(hasRepos());
  return mdl.portfolio.reposList;
};

var saveRepos = function saveRepos(repos) {
  localStorage.setItem("repos-date", JSON.stringify(Date.now()));
  localStorage.setItem("repos", JSON.stringify(repos));
  return repos;
};

var hasRepo = function hasRepo(name) {
  return localStorage.getItem(name);
};

var fetchRepo = function fetchRepo(name) {
  return JSON.parse(hasRepo(name));
};

var saveRepo = function saveRepo(name) {
...
var getRepos = function getRepos(mdl) {
  return hasRepos() ? Promise.resolve(fetchRepos(mdl)) : m.request({
...
var getRepo = function getRepo(state) {
  return hasRepo(state.name) ? Promise.resolve(fetchRepo(state.name)) : m.request({
  ...
  return {
    oninit: function oninit(_ref2) {
      ...
      getRepo(state).then(function (_ref3) {
        ...
        state.status = "loaded";
        mdl.portfolio.repos[state.name] = {
...
var Portfolio = function Portfolio() {
  ...
  return {
    oninit: function oninit(_ref5) {
      ...
      return getRepos(mdl).then(function (repos) {
    ...
    view: function view(_ref6) {
      ...
      return m(".frow", state.status == "failed" && "Error fetching Repos ...", state.status == "loading" && "Loading Repos ...", state.status == "loaded" && mdl.portfolio.reposList.map(function (url) {
        return m(Repo, {
          url: url,
          mdl: mdl
        });
...
exports.slideOutRight = exports.slideInRight = exports.slideInLeft = exports.slideInDown = exports.sideBarIn = exports.sideBarChildren = exports.popIn = exports.fadeInUp = exports.fadeIn = void 0;
var popIn = [{
  transform: "scale(0)",
  opacity: 1
}, {
...
exports.AnimatePage = exports.AnimateChildren = exports.Animate = void 0;
...
exports.range = exports.randomPause = exports.nameFromRoute = exports.log = exports.jsonCopy = exports.isSideBarActive = exports.Pause = exports.NoOp = void 0;
